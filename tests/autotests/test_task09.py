...
try:
    from project.task_6 import hellings_based_cfpq
    from project.task_7 import matrix_based_cfpq
    from project.task_8 import tensor_based_cfpq, cfg_to_rsm, ebnf_to_rsm
    from project.task_9 import gll_based_cfpq
except ImportError:
